...
INSERT INTO Anlass (AnlaID, Bezeichner, Ort, Datum, Kosten, OrgID) VALUES
    ...
    (2, 'Vorstandssitzung', 'Grenchen', '2014-01-17', null, 5),
    (3, 'GV', 'Bettlach', '2013-03-30', 200, 5),
    (4, 'Klaushock', 'Bettlach', '2014-12-06', 150, 5),
    (5, 'Vorstandssitzung', 'Grenchen', '2015-01-21', null, 5),
    (6, 'Turnier', 'Biel', '2014-02-28', 1020, 5),
    (7, 'GV', 'Grenchenberg', '2015-03-29', 250, 4),
    (8, 'Vorstandssitzung', 'Grenchen', '2015-01-19', null, 5);
...
INSERT INTO Spende (SponID, SpenID, AnlaID, Bezeichner, Datum, Betrag) VALUES
    ...
    (2, 7, null, 'Defizittilgung', '2015-04-13', 750),
